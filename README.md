...
│                                  # (model weights in vegetation_mask_model repo)
├── requirements.txt
├── LICENSE
└── README.md
```
...
The tree cover detection model (U-Net trained on PlanetScope imagery at 25 cm resolution) and its trained weights are in a separate repository:
https://github.com/renel33/vegetation_mask_model
